...
phist,tower_list_p=meso.rot_hist(tower_list_p, phist)
nhist,tower_list_n=meso.rot_hist(tower_list_n, nhist)
io.write_histfile(phist,nhist,path)
pfile=path["store"]+'PROT'+str(year)+str(event)+str(time)+'.geojson'
io.write_geojson(tower_list_p,pfile)
nfile=path["store"]+'NROT'+str(year)+str(event)+str(time)+'.geojson'
io.write_geojson(tower_list_n,nfile)
